...
Modified configuration for running PCIe root-port mode.
...
board/pine64/rockpro64_rp/overlay/etc/network/interfaces
board/pine64/rockpro64_rp/overlay/etc/resolv.conf

to set up networking as needed for your environment.

The kernel configuration file used is:

board/pine64/rockpro64_rp/linux.config

Kernel boot arguments can be modified by editiong the file:

board/pine64/rockpro64_rp/extlinux.conf

Build:
======
  $ make rockpro64_rp_defconfig
  $ make
